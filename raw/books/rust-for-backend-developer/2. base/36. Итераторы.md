---
title: Итераторы
source: https://rust-for-backend-developers.github.io/rust-basics/iterators.html
author:
published:
created: 2026-05-16
...
> Note
> 
> Следует отметить, что обычно трэйт `Iterator` реализуется не для типа самой коллекции (массив, вектор и т.д.), а для отдельного типа, чей объект используется для перебора элементов в связанной с итератором коллекции (массиве, векторе и т.д.).
> 
> ![](https://rust-for-backend-developers.github.io/rust-basics/img/iterator.svg)
...
В главе [Циклы](https://rust-for-backend-developers.github.io/rust-basics/loops.html) мы видели такую форму перебора чисел:
...
![](https://rust-for-backend-developers.github.io/rust-basics/img/iterator_nesting.svg)
...
![](https://rust-for-backend-developers.github.io/rust-basics/img/iterator_for_collections.svg)
...
![](https://rust-for-backend-developers.github.io/rust-basics/img/iterator_fold.svg)
...
Также следует заметить, что для итератора определён ряд [специализаций](https://rust-for-backend-developers.github.io/rust-basics/generics.html#specializaciya-treita).
...
Метод [filter\_map](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.filter_map) работает как обычный `map`, однако функция-преобразователь, которую он принимает в качестве аргумента, должна возвращать значение, завёрнутое в `Option`.
