---
title: Коллекции
source: https://rust-for-backend-developers.github.io/dive-deeper/collections.html
author:
published:
created: 2026-05-16
...
Мы уже познакомились с вектором и его устройством в памяти в главе [Вектор](https://rust-for-backend-developers.github.io/rust-basics/vector.html).
...
![](https://rust-for-backend-developers.github.io/dive-deeper/img/collections-linked_list.svg)
...
![](https://rust-for-backend-developers.github.io/dive-deeper/img/collections-vecdeque.svg)
...
2. к хеш-коду применяется маска (bucket\_mask), чтобы определить номер бакета, в котором будет храниться эта пара
...
![](https://rust-for-backend-developers.github.io/dive-deeper/img/collections-hash_amp.svg)
...
![](https://rust-for-backend-developers.github.io/dive-deeper/img/collections-btree_map.svg)
...
![](https://rust-for-backend-developers.github.io/dive-deeper/img/collections-binary_heap.svg)
