...
source_count: 1
source_path: "raw/books/the_rust_programming_language/6.2. The match Control Flow Construct.md"
...
- Path: `raw/books/the_rust_programming_language/6.2. The match Control Flow Construct.md`
- Type: book section
