...
source: "https://doc.rust-lang.org/stable/book/ch17-06-futures-tasks-threads.html"
author:
published:
created: 2026-05-07
description:
...
[Listing 17-25](#listing-17-25): Sending messages with blocking code in a thread and awaiting the messages in an async block
...
This isn’t the last you’ll see of concurrency in this book. The project in [Chapter 21](https://doc.rust-lang.org/stable/book/ch21-00-final-project-a-web-server.html) will apply these concepts in a more realistic situation than the simpler examples discussed here and compare problem-solving with threading versus tasks and futures more directly.
