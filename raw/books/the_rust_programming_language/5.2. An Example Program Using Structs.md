...
source: "https://doc.rust-lang.org/stable/book/ch05-02-example-structs.html"
author:
published:
created: 2026-05-06
description:
...
[Listing 5-8](#listing-5-8): Calculating the area of a rectangle specified by separate width and height variables
...
[Listing 5-9](#listing-5-9): Specifying the width and height of the rectangle with a tuple
...
[Listing 5-10](#listing-5-10): Defining a `Rectangle` struct
...
[Listing 5-11](#listing-5-11): Attempting to print a `Rectangle` instance
...
[Listing 5-12](#listing-5-12): Adding the attribute to derive the `Debug` trait and printing the `Rectangle` instance using debug formatting
