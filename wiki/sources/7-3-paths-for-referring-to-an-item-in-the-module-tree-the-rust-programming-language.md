...
source_count: 1
source_path: "raw/books/the_rust_programming_language/7.3. Paths for Referring to an Item in the Module Tree - The Rust Programming Language.md"
...
- Path: `raw/books/the_rust_programming_language/7.3. Paths for Referring to an Item in the Module Tree - The Rust Programming Language.md`
- Type: book section
