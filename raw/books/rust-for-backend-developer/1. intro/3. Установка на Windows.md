...
source: "https://rust-for-backend-developers.github.io/setup/install-on-windows.html"
author:
published:
created: 2026-05-16
...
![](https://rust-for-backend-developers.github.io/setup/img/install_sdk-0.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/install_visual_studio_min_components.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/install_sdk-4.png)

Выбираем 1-й вариант (просто установить тулчейн с настройками по-умолчанию).

![](https://rust-for-backend-developers.github.io/setup/img/install_sdk-5.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/verify_installation.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/mingw_folder.png)

2) Добавте каталог `mingw64\bin` в системную переменную `Path`.

![](https://rust-for-backend-developers.github.io/setup/img/mingw_path.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/mingw_rustup_1.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/mingw_rustup_2.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/mingw_rustup_3.png)

Для остальных параметров подходят значения по умолчанию.

![](https://rust-for-backend-developers.github.io/setup/img/mingw_rustup_4.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/mingw_rustup_5.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/msys2_install_1.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/msys2_install_2.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/msys2_install_3.png)

`pacman -S base-devel`

![](https://rust-for-backend-developers.github.io/setup/img/msys2_install_4.png)
...
![](https://rust-for-backend-developers.github.io/setup/img/msys2_install_5.png)
