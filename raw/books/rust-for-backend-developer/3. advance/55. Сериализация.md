---
title: Сериализация
source: https://rust-for-backend-developers.github.io/dive-deeper/serialization.html
author:
published:
created: 2026-05-16
...
![](https://rust-for-backend-developers.github.io/dive-deeper/img/serde_impl.svg)

(крэйт serde\_json использует описание типа, предоставляемое реализацией трэйта Serialize, чтобы сериализовать объект типа МойТип в JSON)
...
- [serde\_json::from\_str](https://docs.rs/serde_json/latest/serde_json/fn.from_str.html) — десериализует JSON-строку в объект
...
Также в крэйте serde\_json определено перечисление [Value](https://docs.rs/serde_json/latest/serde_json/enum.Value.html), которое по сути является отображением JSON типов на Rust перечисление.
