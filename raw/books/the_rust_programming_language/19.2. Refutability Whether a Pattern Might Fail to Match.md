...
source: "https://doc.rust-lang.org/stable/book/ch19-02-refutability.html"
author:
published:
created: 2026-05-07
description:
...
[Listing 19-8](#listing-19-8): Attempting to use a refutable pattern with `let`
...
[Listing 19-9](#listing-19-9): Using `let...else` and a block with refutable patterns instead of `let`
...
[Listing 19-10](#listing-19-10): Attempting to use an irrefutable pattern with `let...else`
