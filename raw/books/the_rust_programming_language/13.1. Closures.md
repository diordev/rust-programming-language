...
[Listing 13-1](#listing-13-1): Shirt company giveaway situation
...
[Listing 13-2](#listing-13-2): Adding optional type annotations of the parameter and return value types in the closure
...
[Listing 13-3](#listing-13-3): Attempting to call a closure whose types are inferred with two different types
...
[Listing 13-4](#listing-13-4): Defining and calling a closure that captures an immutable reference
...
[Listing 13-5](#listing-13-5): Defining and calling a closure that captures a mutable reference
...
[Listing 13-6](#listing-13-6): Using `move` to force the closure for the thread to take ownership of `list`
...
[Listing 13-7](#listing-13-7): Using `sort_by_key` to order rectangles by width
...
[Listing 13-8](#listing-13-8): Attempting to use an `FnOnce` closure with `sort_by_key`
...
[Listing 13-9](#listing-13-9): Using an `FnMut` closure with `sort_by_key` is allowed.
