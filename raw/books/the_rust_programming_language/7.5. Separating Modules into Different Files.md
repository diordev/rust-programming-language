...
source: "https://doc.rust-lang.org/stable/book/ch07-05-separating-modules-into-different-files.html"
author:
published:
created: 2026-05-06
description:
...
[Listing 7-21](#listing-7-21): Declaring the `front_of_house` module whose body will be in *src/front\_of\_house.rs*
...
[Listing 7-22](#listing-7-22): Definitions inside the `front_of_house` module in *src/front\_of\_house.rs*
