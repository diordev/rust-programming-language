...
source: "https://doc.rust-lang.org/stable/book/appendix-05-editions.html"
author:
published:
created: 2026-05-07
description:
...
For more details, see [*The Rust Edition Guide*](https://doc.rust-lang.org/stable/edition-guide). This is a complete book that enumerates the differences between editions and explains how to automatically upgrade your code to a new edition via `cargo fix`.