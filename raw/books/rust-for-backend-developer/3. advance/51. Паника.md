---
title: Паника
source: https://rust-for-backend-developers.github.io/dive-deeper/panic.html
author:
published:
created: 2026-05-16
...
Стандартная библиотека предоставляет функцию-обёртку [catch\_unwind](https://doc.rust-lang.org/std/panic/fn.catch_unwind.html), которая принимает на вход замыкание и выполняет его.
