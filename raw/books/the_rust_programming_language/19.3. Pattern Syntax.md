...
source: "https://doc.rust-lang.org/stable/book/ch19-03-pattern-syntax.html"
author:
published:
created: 2026-05-07
description:
...
[Listing 19-11](#listing-19-11): A `match` expression with an arm that introduces a new variable which shadows an existing variable `y`
...
[Listing 19-12](#listing-19-12): Destructuring a struct’s fields into separate variables
...
[Listing 19-13](#listing-19-13): Destructuring struct fields using struct field shorthand
...
[Listing 19-14](#listing-19-14): Destructuring and matching literal values in one pattern
...
[Listing 19-15](#listing-19-15): Destructuring enum variants that hold different kinds of values
...
[Listing 19-16](#listing-19-16): Matching on nested enums
...
[Listing 19-17](#listing-19-17): Using `_` in a function signature
...
[Listing 19-18](#listing-19-18): Using an underscore within patterns that match `Some` variants when we don’t need to use the value inside the `Some`
...
[Listing 19-19](#listing-19-19): Ignoring multiple parts of a tuple
...
[Listing 19-20](#listing-19-20): Starting a variable name with an underscore to avoid getting unused variable warnings
...
[Listing 19-21](#listing-19-21): An unused variable starting with an underscore still binds the value, which might take ownership of the value.
...
[Listing 19-22](#listing-19-22): Using an underscore does not bind the value.
...
[Listing 19-23](#listing-19-23): Ignoring all fields of a `Point` except for `x` by using `..`
...
[Listing 19-24](#listing-19-24): Matching only the first and last values in a tuple and ignoring all other values
...
[Listing 19-25](#listing-19-25): An attempt to use `..` in an ambiguous way
...
[Listing 19-26](#listing-19-26): Adding a match guard to a pattern
...
[Listing 19-27](#listing-19-27): Using a match guard to test for equality with an outer variable
...
[Listing 19-28](#listing-19-28): Combining multiple patterns with a match guard
...
[Listing 19-29](#listing-19-29): Using `@` to bind to a value in a pattern while also testing it
