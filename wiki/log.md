...
- Created [[14-more-about-cargo-and-crates-io-the-rust-programming-language]] in `wiki/sources/`.
- Created [[14-1-customizing-builds-with-release-profiles-the-rust-programming-language]] in `wiki/sources/`.
- Created [[14-2-publishing-a-crate-to-crates-io-the-rust-programming-language]] in `wiki/sources/`.
- Created [[14-3-cargo-workspaces-the-rust-programming-language]] in `wiki/sources/`.
- Created [[14-4-installing-binaries-with-cargo-install-the-rust-programming-language]] in `wiki/sources/`.
- Created [[14-5-extending-cargo-with-custom-commands-the-rust-programming-language]] in `wiki/sources/`.
- Created [[14-more-about-cargo-and-crates-io]] chapter page in `wiki/chapters/`.
...
- Ingested `raw/books/the_rust_programming_language/13.3. Improving Our IO Project - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/13.4. Performance in Loops vs. Iterators - The Rust Programming Language.md`.
- Created [[13-3-improving-our-io-project-the-rust-programming-language]] in `wiki/sources/`.
- Created [[13-4-performance-in-loops-vs-iterators-the-rust-programming-language]] in `wiki/sources/`.
...
- Ingested `raw/books/the_rust_programming_language/13. Functional Language Features Iterators and Closures - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/13.1. Closures - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/13.2. Processing a Series of Items with Iterators - The Rust Programming Language.md`.
- Created [[13-functional-language-features-the-rust-programming-language]] in `wiki/sources/`.
- Created [[13-1-closures-the-rust-programming-language]] in `wiki/sources/`.
- Created [[13-2-processing-a-series-of-items-with-iterators-the-rust-programming-language]] in `wiki/sources/`.
...
- Ingested `raw/books/the_rust_programming_language/12.5. Working with Environment Variables - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/12.6. Redirecting Errors to Standard Error - The Rust Programming Language.md`.
- Created [[12-5-working-with-environment-variables-the-rust-programming-language]] in `wiki/sources/`.
- Created [[12-6-redirecting-errors-to-standard-error-the-rust-programming-language]] in `wiki/sources/`.
...
- Ingested `raw/books/the_rust_programming_language/0. The Rust Programming Language - The Rust Programming Language.md`.
- Created [[0-the-rust-programming-language-the-rust-programming-language]] in `wiki/sources/`.
...
- Ingested `raw/books/the_rust_programming_language/0.1. Foreword - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/0.2. Introduction - The Rust Programming Language.md`.
- Created [[0-1-foreword-the-rust-programming-language]] and [[0-2-introduction-the-rust-programming-language]] in `wiki/sources/`.
- Created chapter page [[0-2-introduction|0.2. Introduction]].
...
- Ingested `raw/books/the_rust_programming_language/1. Getting Started - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/1.1. Installation - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/1.2. Hello, World! - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/1.3. Hello, Cargo! - The Rust Programming Language.md`.
- Created source summaries [[1-getting-started-the-rust-programming-language]], [[1-1-installation-the-rust-programming-language]], [[1-2-hello-world-the-rust-programming-language]], and [[1-3-hello-cargo-the-rust-programming-language]].
- Created chapter page [[1-getting-started|1. Getting Started]], example page [[hello-world]], and tool pages [[rustup]], [[rustc]], and [[cargo|Cargo]].
- Updated `wiki/index.md`, `wiki/overview.md`, and [[rust-learning-roadmap]].
...
- Renamed chapter pages to [[0-2-introduction|0.2. Introduction]] and [[1-getting-started|1. Getting Started]].
...
- Ingested `raw/books/the_rust_programming_language/2. Programming a Guessing Game - The Rust Programming Language.md`.
- Created source summary [[2-programming-a-guessing-game-the-rust-programming-language]].
- Created chapter page [[2-programming-a-guessing-game|2. Programming a Guessing Game]] and project page [[guessing-game]].
...
- Ingested `raw/books/the_rust_programming_language/3. Common Programming Concepts - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/3.1. Variables and Mutability - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/3.2. Data Types - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/3.3. Functions - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/3.4. Comments - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/3.5. Control Flow - The Rust Programming Language.md`.
- Created source summaries [[3-common-programming-concepts-the-rust-programming-language]], [[3-1-variables-and-mutability-the-rust-programming-language]], [[3-2-data-types-the-rust-programming-language]], [[3-3-functions-the-rust-programming-language]], [[3-4-comments-the-rust-programming-language]], and [[3-5-control-flow-the-rust-programming-language]].
- Created chapter page [[3-common-programming-concepts|3. Common Programming Concepts]] and exercise page [[chapter-3-practice]].
...
- Ingested `raw/books/the_rust_programming_language/4. Understanding Ownership - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/4.1. What is Ownership? - The Rust Programming Language.md`.
- Created source summaries [[4-understanding-ownership-the-rust-programming-language]] and [[4-1-what-is-ownership-the-rust-programming-language]].
- Created chapter page [[4-understanding-ownership|4. Understanding Ownership]].
...
- Ingested `raw/books/the_rust_programming_language/4.2. References and Borrowing - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/4.3. The Slice Type - The Rust Programming Language.md`.
- Created source summaries [[4-2-references-and-borrowing-the-rust-programming-language]] and [[4-3-the-slice-type-the-rust-programming-language]].
- Updated chapter page [[4-understanding-ownership|4. Understanding Ownership]] and concept page [[ownership]].
...
- Ingested `raw/books/the_rust_programming_language/5. Using Structs to Structure Related Data - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/5.1. Defining and Instantiating Structs - The Rust Programming Language.md`.
- Created source summaries [[5-using-structs-to-structure-related-data-the-rust-programming-language]] and [[5-1-defining-and-instantiating-structs-the-rust-programming-language]].
- Created chapter page [[5-using-structs-to-structure-related-data|5. Using Structs to Structure Related Data]].
...
- Ingested `raw/books/the_rust_programming_language/5.2. An Example Program Using Structs - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/5.3. Methods - The Rust Programming Language.md`.
- Created source summaries [[5-2-an-example-program-using-structs-the-rust-programming-language]] and [[5-3-methods-the-rust-programming-language]].
- Expanded chapter page [[5-using-structs-to-structure-related-data|5. Using Structs to Structure Related Data]].
...
- Ingested `raw/books/the_rust_programming_language/6. Enums and Pattern Matching - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/6.1. Defining an Enum - The Rust Programming Language.md`.
- Created source summaries [[6-enums-and-pattern-matching-the-rust-programming-language]] and [[6-1-defining-an-enum-the-rust-programming-language]].
- Created chapter page [[6-enums-and-pattern-matching|6. Enums and Pattern Matching]].
...
- Ingested `raw/books/the_rust_programming_language/6.2. The match Control Flow Construct - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/6.3. Concise Control Flow with if let and let...else - The Rust Programming Language.md`.
- Created source summaries [[6-2-the-match-control-flow-construct-the-rust-programming-language]] and [[6-3-concise-control-flow-with-if-let-and-let-else-the-rust-programming-language]].
- Expanded chapter page [[6-enums-and-pattern-matching|6. Enums and Pattern Matching]].
...
- Ingested `raw/books/the_rust_programming_language/7. Packages, Crates, and Modules - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/7.1. Packages and Crates - The Rust Programming Language.md`.
- Created source summaries [[7-packages-crates-and-modules-the-rust-programming-language]] and [[7-1-packages-and-crates-the-rust-programming-language]].
- Created chapter page [[7-packages-crates-and-modules|7. Packages, Crates, and Modules]].
...
- Ingested `raw/books/the_rust_programming_language/7.2. Control Scope and Privacy with Modules - The Rust Programming Language.md`.
- Created source summary [[7-2-control-scope-and-privacy-with-modules-the-rust-programming-language]].
- Expanded chapter page [[7-packages-crates-and-modules|7. Packages, Crates, and Modules]].
...
- Ingested `raw/books/the_rust_programming_language/7.3. Paths for Referring to an Item in the Module Tree - The Rust Programming Language.md`.
- Created source summary [[7-3-paths-for-referring-to-an-item-in-the-module-tree-the-rust-programming-language]].
- Expanded chapter page [[7-packages-crates-and-modules|7. Packages, Crates, and Modules]].
...
- Ingested `raw/books/the_rust_programming_language/7.4. Bringing Paths Into Scope with the use Keyword - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/7.5. Separating Modules into Different Files - The Rust Programming Language.md`.
- Created source summaries [[7-4-bringing-paths-into-scope-with-the-use-keyword-the-rust-programming-language]] and [[7-5-separating-modules-into-different-files-the-rust-programming-language]].
- Expanded chapter page [[7-packages-crates-and-modules|7. Packages, Crates, and Modules]].
...
- Ingested `raw/books/the_rust_programming_language/8. Common Collections - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/8.1 Storing Lists of Values with Vectors - The Rust Programming Language.md`.
- Created source summaries [[8-common-collections-the-rust-programming-language]] and [[8-1-storing-lists-of-values-with-vectors-the-rust-programming-language]].
- Created chapter page [[8-common-collections|8. Common Collections]].
...
- Ingested `raw/books/the_rust_programming_language/8.2. Storing UTF-8 Encoded Text with Strings - The Rust Programming Language.md`.
- Created source summary [[8-2-storing-utf-8-encoded-text-with-strings-the-rust-programming-language]].
- Expanded chapter page [[8-common-collections|8. Common Collections]].
...
- Ingested `raw/books/the_rust_programming_language/8.3. Storing Keys with Associated Values in Hash Maps - The Rust Programming Language.md`.
- Created source summary [[8-3-storing-keys-with-associated-values-in-hash-maps-the-rust-programming-language]].
- Expanded chapter page [[8-common-collections|8. Common Collections]] and core [[hash-map|HashMap]] concept page.
...
- Ingested `raw/books/the_rust_programming_language/9. Error Handling - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/9.1. Unrecoverable Errors with panic! - The Rust Programming Language.md`.
- Created source summaries [[9-error-handling-the-rust-programming-language]] and [[9-1-unrecoverable-errors-with-panic-the-rust-programming-language]].
- Created chapter page [[9-error-handling|9. Error Handling]].
...
- Ingested `raw/books/the_rust_programming_language/9.2. Recoverable Errors with Result - The Rust Programming Language.md`.
- Created source summary [[9-2-recoverable-errors-with-result-the-rust-programming-language]].
- Expanded chapter page [[9-error-handling|9. Error Handling]] with `Result<T, E>`, `File::open`, `ErrorKind`, `unwrap`, `expect`, error propagation, `?`, and `main -> Result<(), E>`.
...
- Ingested `raw/books/the_rust_programming_language/9.3. To panic! or Not to panic! - The Rust Programming Language.md`.
- Created source summary [[9-3-to-panic-or-not-to-panic-the-rust-programming-language]].
- Completed chapter page [[9-error-handling|9. Error Handling]] with panic-vs-Result decision criteria, examples/prototypes/tests guidance, bad state, contracts, invariants, and custom validation types.
...
- Ingested `raw/books/the_rust_programming_language/10. Generic Types, Traits, and Lifetimes - The Rust Programming Language.md`.
- Created source summary [[10-generic-types-traits-and-lifetimes-the-rust-programming-language]].
- Created chapter page [[10-generic-types-traits-and-lifetimes|10. Generic Types, Traits, and Lifetimes]].
...
- Ingested `raw/books/the_rust_programming_language/10.1. Generic Data Types - The Rust Programming Language.md`.
- Created source summary [[10-1-generic-data-types-the-rust-programming-language]].
- Expanded chapter page [[10-generic-types-traits-and-lifetimes|10. Generic Types, Traits, and Lifetimes]] with generic function, struct, enum, method, and monomorphization details.
...
- Ingested `raw/books/the_rust_programming_language/10.2. Defining Shared Behavior with Traits - The Rust Programming Language.md`.
- Created source summary [[10-2-defining-shared-behavior-with-traits-the-rust-programming-language]].
- Expanded chapter page [[10-generic-types-traits-and-lifetimes|10. Generic Types, Traits, and Lifetimes]] with trait definitions, implementations, default implementations, trait bounds, `impl Trait`, `where` clauses, orphan rule, conditional methods, and blanket implementations.
...
- Ingested `raw/books/the_rust_programming_language/10.3. Validating References with Lifetimes - The Rust Programming Language.md`.
- Created [[10-3-validating-references-with-lifetimes-the-rust-programming-language]] in `wiki/sources/`.
...
- Ingested `raw/books/the_rust_programming_language/11. Writing Automated Tests - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/11.1. How to Write Tests - The Rust Programming Language.md`.
- Created [[11-writing-automated-tests-the-rust-programming-language]] va [[11-1-how-to-write-tests-the-rust-programming-language]] in `wiki/sources/`.
...
- Ingested `raw/books/the_rust_programming_language/11.2. Controlling How Tests Are Run - The Rust Programming Language.md`.
- Created [[11-2-controlling-how-tests-are-run-the-rust-programming-language]] in `wiki/sources/`.
...
- Ingested `raw/books/the_rust_programming_language/11.3. Test Organization - The Rust Programming Language.md`.
- Created [[11-3-test-organization-the-rust-programming-language]] in `wiki/sources/`.
...
- Ingested `raw/books/the_rust_programming_language/12. An IO Project Building a Command Line Program - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/12.1. Accepting Command Line Arguments - The Rust Programming Language.md`.
- Ingested `raw/books/the_rust_programming_language/12.2. Reading a File - The Rust Programming Language.md`.
- Created source summaries [[12-an-io-project-the-rust-programming-language]], [[12-1-accepting-command-line-arguments-the-rust-programming-language]], and [[12-2-reading-a-file-the-rust-programming-language]] in `wiki/sources/`.
...
- Ingested `raw/books/the_rust_programming_language/12.3. Refactoring to Improve Modularity and Error Handling - The Rust Programming Language.md`.
- Created source summary [[12-3-refactoring-to-improve-modularity-and-error-handling-the-rust-programming-language]] in `wiki/sources/`.
...
- Ingested `raw/books/the_rust_programming_language/12.4. Adding Functionality with Test Driven Development - The Rust Programming Language.md`.
- Created source summary [[12-4-adding-functionality-with-test-driven-development-the-rust-programming-language]] in `wiki/sources/`.
...
- **Singan linklar:** 20 ta broken wikilink aniqlandi va 0 ga tushirildi.
  ...
  - Tuzatildi: `11-writing-automated-tests` → [[11-writing-automated-tests-the-rust-programming-language|11-writing-automated-tests-the-rust-programming-language]] (`12-an-io-project` chapter).
- **Orphan sahifalar:** 0.
