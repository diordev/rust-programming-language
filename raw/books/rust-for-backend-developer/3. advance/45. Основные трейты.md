---
title: Основные трейты
source: https://rust-for-backend-developers.github.io/dive-deeper/common-traits.html
author:
published:
created: 2026-05-16
...
- [Sync](https://doc.rust-lang.org/std/marker/trait.Sync.html) — маркерный трэйт, который автоматически добавляется компилятором к типу, если к значению этого типа безопасно обращаться из нескольких потоков. О нём мы подробнее поговорим в главе про [Многопоточность](https://rust-for-backend-developers.github.io/dive-deeper/multithreading.html).
- [Send](https://doc.rust-lang.org/std/marker/trait.Send.html) — маркерный трэйт, который автоматически добавляется компилятором для типов, чьи значения могут передаваться в другой поток. О нём мы также поговорим в главе про [Многопоточность](https://rust-for-backend-developers.github.io/dive-deeper/multithreading.html).
