---
title: Логирование
source: https://rust-for-backend-developers.github.io/dive-deeper/logging.html
author:
published:
created: 2026-05-16
...
В экосистеме Rust также присутствует другая популярная библиотека логирования — [log](https://crates.io/crates/log) (фасад) и её реализации: [env\_logger](https://crates.io/crates/env_logger) и [log4rs](https://crates.io/crates/log4rs). Но мы сосредоточимся только на tracing по двум причинам:
...
![](https://rust-for-backend-developers.github.io/dive-deeper/img/logging-tracing_subscriber_architecture.svg)
...
![](https://rust-for-backend-developers.github.io/dive-deeper/img/logging-layers.svg)
