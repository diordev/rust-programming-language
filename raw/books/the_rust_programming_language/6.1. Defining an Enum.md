...
[Listing 6-1](#listing-6-1): Storing the data and `IpAddrKind` variant of an IP address using a `struct`
...
[Listing 6-2](#listing-6-2): A `Message` enum whose variants each store different amounts and types of values
