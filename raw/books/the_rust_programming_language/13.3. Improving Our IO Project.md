...
[Listing 13-17](#listing-13-17): Reproduction of the `Config::build` function from Listing 12-23
...
[Listing 13-18](#listing-13-18): Passing the return value of `env::args` to `Config::build`
...
[Listing 13-19](#listing-13-19): Updating the signature of `Config::build` to expect an iterator
...
[Listing 13-20](#listing-13-20): Changing the body of `Config::build` to use iterator methods
...
[Listing 13-21](#listing-13-21): The implementation of the `search` function from Listing 12-19
...
[Listing 13-22](#listing-13-22): Using iterator adapter methods in the implementation of the `search` function
