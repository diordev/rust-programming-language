...
source: "https://doc.rust-lang.org/stable/book/ch17-03-more-futures.html"
author:
published:
created: 2026-05-07
description:
...
[Listing 17-14](#listing-17-14): Using `thread::sleep` to simulate slow operations
...
[Listing 17-15](#listing-17-15): Calling the `slow` function to simulate slow operations
...
[Listing 17-16](#listing-17-16): Using `trpl::sleep` to let operations switch off making progress
...
[Listing 17-17](#listing-17-17): Using `yield_now` to let operations switch off making progress
...
[Listing 17-18](#listing-17-18): Using our imagined `timeout` to run a slow operation with a time limit
...
[Listing 17-19](#listing-17-19): Defining the signature of `timeout`
...
[Listing 17-20](#listing-17-20): Defining `timeout` with `select` and `sleep`
