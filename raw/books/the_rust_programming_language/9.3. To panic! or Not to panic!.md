...
source: "https://doc.rust-lang.org/stable/book/ch09-03-to-panic-or-not-to-panic.html"
author:
published:
created: 2026-05-06
description:
...
- There’s not a good way to encode this information in the types you use. We’ll work through an example of what we mean in [“Encoding States and Behavior as Types”](https://doc.rust-lang.org/stable/book/ch18-03-oo-design-patterns.html#encoding-states-and-behavior-as-types) in Chapter 18.
...
[Listing 9-13](#listing-9-13): A `Guess` type that will only continue with values between 1 and 100
