...
[Listing 8-11](#listing-8-11): Creating a new, empty `String`
...
[Listing 8-12](#listing-8-12): Using the `to_string` method to create a `String` from a string literal
...
[Listing 8-13](#listing-8-13): Using the `String::from` function to create a `String` from a string literal
...
[Listing 8-14](#listing-8-14): Storing greetings in different languages in strings
...
#### Appending with push\_str or push
...
[Listing 8-15](#listing-8-15): Appending a string slice to a `String` using the `push_str` method
...
[Listing 8-16](#listing-8-16): Using a string slice after appending its contents to a `String`
...
[Listing 8-17](#listing-8-17): Adding one character to a `String` value using `push`
...
[Listing 8-18](#listing-8-18): Using the `+` operator to combine two `String` values into a new `String` value
...
[Listing 8-19](#listing-8-19): Attempting to use indexing syntax with a `String`
