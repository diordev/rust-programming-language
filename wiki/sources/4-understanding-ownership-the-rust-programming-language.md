...
source_count: 1
source_path: "raw/books/the_rust_programming_language/4. Understanding Ownership - The Rust Programming Language.md"
...
- Path: `raw/books/the_rust_programming_language/4. Understanding Ownership - The Rust Programming Language.md`
...
Chapter scope'i: [[ownership]], [[borrowing]], [[slices]], va Rust data'ni memoryda qanday joylashtirishi. Hozir ingest qilingan material opener va [[4-1-what-is-ownership-the-rust-programming-language|4.1. What Is Ownership?]]ni qamrab oladi; borrowing va slices keyingi `4.2`/`4.3` sources qo'shilganda to'ldiriladi.
