...
source: "https://doc.rust-lang.org/stable/book/ch05-03-method-syntax.html"
author:
published:
created: 2026-05-06
description:
...
[Listing 5-13](#listing-5-13): Defining an `area` method on the `Rectangle` struct
...
[Listing 5-14](#listing-5-14): Using the as-yet-unwritten `can_hold` method
...
[Listing 5-15](#listing-5-15): Implementing the `can_hold` method on `Rectangle` that takes another `Rectangle` instance as a parameter
...
[Listing 5-16](#listing-5-16): Rewriting Listing 5-15 using multiple `impl` blocks
