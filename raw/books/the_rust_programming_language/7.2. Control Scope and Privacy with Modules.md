...
source: "https://doc.rust-lang.org/stable/book/ch07-02-defining-modules-to-control-scope-and-privacy.html"
author:
published:
created: 2026-05-06
description:
...
[Listing 7-1](#listing-7-1): A `front_of_house` module containing other modules that then contain functions
...
[Listing 7-2](#listing-7-2): The module tree for the code in Listing 7-1
