...
source: "https://doc.rust-lang.org/stable/book/ch16-02-message-passing.html"
author:
published:
created: 2026-05-07
description:
...
[Listing 16-6](#listing-16-6): Creating a channel and assigning the two halves to `tx` and `rx`
...
[Listing 16-7](#listing-16-7): Moving `tx` to a spawned thread and sending `"hi"`
...
[Listing 16-8](#listing-16-8): Receiving the value `"hi"` in the main thread and printing it
...
[Listing 16-9](#listing-16-9): Attempting to use `val` after we’ve sent it down the channel
...
[Listing 16-10](#listing-16-10): Sending multiple messages and pausing between each one
...
[Listing 16-11](#listing-16-11): Sending multiple messages from multiple producers
