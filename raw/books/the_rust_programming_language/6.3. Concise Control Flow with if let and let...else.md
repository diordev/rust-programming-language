...
source: "https://doc.rust-lang.org/stable/book/ch06-03-if-let.html"
author:
published:
created: 2026-05-06
description:
...
[Listing 6-6](#listing-6-6): A `match` that only cares about executing code when the value is `Some`
...
[Listing 6-7](#listing-6-7): Checking whether a state existed in 1900 by using conditionals nested inside an `if let`
...
[Listing 6-8](#listing-6-8): Using `if let` to produce a value or return early
...
[Listing 6-9](#listing-6-9): Using `let...else` to clarify the flow through the function
