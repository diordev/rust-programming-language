---
title: Newtype паттерн
source: https://rust-for-backend-developers.github.io/dive-deeper/newtype-pattern.html
author:
published:
created: 2026-05-16
...
Одно из самых неудобных ограничений Rust — Orphan rule, о котором мы уже упоминали в главе [Трэйты](https://rust-for-backend-developers.github.io/rust-basics/traits.html#impl-for-foreign-types). Напомним, Orphan Rule гласит:
