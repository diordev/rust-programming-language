...
source_count: 1
source_path: "raw/books/the_rust_programming_language/6.3. Concise Control Flow with if let and let...else.md"
...
- Path: `raw/books/the_rust_programming_language/6.3. Concise Control Flow with if let and let...else.md`
- Type: book section
