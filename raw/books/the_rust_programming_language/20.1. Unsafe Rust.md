...
source: "https://doc.rust-lang.org/stable/book/ch20-01-unsafe-rust.html"
author:
published:
created: 2026-05-07
description:
...
[Listing 20-1](#listing-20-1): Creating raw pointers with the raw borrow operators
...
[Listing 20-2](#listing-20-2): Creating a raw pointer to an arbitrary memory address
...
[Listing 20-3](#listing-20-3): Dereferencing raw pointers within an `unsafe` block
...
[Listing 20-4](#listing-20-4): Using the safe `split_at_mut` function
...
[Listing 20-5](#listing-20-5): An attempted implementation of `split_at_mut` using only safe Rust
...
[Listing 20-7](#listing-20-7): Creating a slice from an arbitrary memory location
...
[Listing 20-8](#listing-20-8): Declaring and calling an `extern` function defined in another language
...
[Listing 20-9](#listing-20-9): Explicitly marking a function as `safe` within an `unsafe extern` block and calling it safely
...
[Listing 20-11](#listing-20-11): Reading from or writing to a mutable static variable is unsafe.
