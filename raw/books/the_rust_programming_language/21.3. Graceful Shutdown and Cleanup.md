...
source: "https://doc.rust-lang.org/stable/book/ch21-03-graceful-shutdown-and-cleanup.html"
author:
published:
created: 2026-05-07
description:
...
[Listing 21-22](#listing-21-22): Joining each thread when the thread pool goes out of scope
...
[Listing 21-23](#listing-21-23): Explicitly dropping `sender` before joining the `Worker` threads
...
[Listing 21-24](#listing-21-24): Explicitly breaking out of the loop when `recv` returns an error
...
[Listing 21-25](#listing-21-25): Shutting down the server after serving two requests by exiting the loop
