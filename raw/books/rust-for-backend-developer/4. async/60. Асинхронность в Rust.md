---
title: Асинхронность в Rust
source: https://rust-for-backend-developers.github.io/async/async-in-rust.html
author:
published:
created: 2026-05-16
...
Если в вашем редакторе кода имеется поддержка Rust LSP, благодаря чему отображаются выведенные типы, то скорее всего пример из секции [Исполнение async-функции](https://rust-for-backend-developers.github.io/async/async-in-rust.html#async-fn-exec) у вас в редакторе выглядит так:
...
![](https://rust-for-backend-developers.github.io/async/img/async-application_achitecture.svg)
