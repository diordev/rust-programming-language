...
source_count: 1
source_path: "raw/books/the_rust_programming_language/8.3. Storing Keys with Associated Values in Hash Maps - The Rust Programming Language.md"
...
- Path: `raw/books/the_rust_programming_language/8.3. Storing Keys with Associated Values in Hash Maps - The Rust Programming Language.md`
- Type: book section
